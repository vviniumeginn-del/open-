...
| 文章类型 | 推荐配色 | 色彩代码 | 视觉效果 |
|---------|---------|---------|---------|
| **现代家居** | 米白渐变 | #f5f1ea → #cfc7be | 温暖、舒适 |
| **原木自然** | 浅木色渐变 | #d8c3a5 → #a8b8a1 | 自然、治愈 |
| **轻奢质感** | 奶油白 → 雾金 | #f7f2eb → #d3b68a | 高级、克制 |
| **北欧清爽** | 浅灰 → 天空蓝 | #e6e9ec → #a9c4d8 | 清爽、轻盈 |
| **商务空间** | 深灰 → 石墨金 | #3f3f3f → #bfa37c | 稳重、专业 |
...
```
A warm, inviting cover image for [主题名称] article.

Design: soft gradient background from warm beige (#f5f1ea) to light wood (#d8c3a5), with gentle natural light and subtle texture.

Central visual elements (positioned behind text):
- Minimalist room silhouette (sofa/table/lighting) in soft 3D style
- Subtle material texture overlays (wood grain, linen weave)
- Soft light rays and shallow depth of field

Text layout (CRITICAL - all text centered both horizontally and vertically):
- CENTER of image: Large bold title '[主题名称]' in white or warm gray, modern sans-serif font
...
Style: modern, warm, lifestyle, magazine-quality
Visual mood: calm, cozy, premium, trustworthy
Color palette: beige/wood/cream tones with white accents
...
- Professional design suitable for home & furniture article cover
```
...
```
A premium product cover image for [产品名] article.
Design: elegant gradient background from [主题色1] to [主题色2] with subtle material textures.
Background elements: 3D product silhouette (sofa/table/chair) or close-up material texture in soft focus.
Text layout (CRITICAL - centered composition):
- CENTER (vertically and horizontally): main title "[产品名]" in bold, clean font
- Directly below title (still in center area): subtitle "[核心价值说明]" in Chinese
IMPORTANT: All text must be positioned in the CENTER of the image, both horizontally and vertically, NOT at top or sides.
Visual elements: warm lighting, soft shadows, minimalistic scene cues.
Style: modern, refined, high-end, magazine-quality.
Visual mood: premium, trustworthy, cozy.
...
```
A tasteful cover image for styling guide about [主题].
Design: soft gradient background (light gray to muted blue, or cream to sage green).
Background elements: layered fabric swatches, color chips, and subtle decor silhouettes.
Text layout (CRITICAL - centered composition):
- CENTER (vertically and horizontally): bold headline "[主题]" in large white or warm gray font
- Directly below headline (still in center area): Chinese tagline "[风格一句话价值]"
IMPORTANT: All text must be positioned in the CENTER of the image, both horizontally and vertically, NOT at top or bottom.
Visual mood: calm, tasteful, inspiring.
Style: clean, modern, lifestyle-oriented.
